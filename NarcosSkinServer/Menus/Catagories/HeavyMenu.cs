...
public static class HeavyMenu
{
    ...
    {
        var menu = new WasdMenu("Heavy", plugin)
        {
            PrevMenu = previousMenu
        };

        foreach (var weapon in SkinCatalog.Weapons.Values.Where(w => w.Category == WeaponCategory.Heavy))
        {
